...
function ProductList({ onHomeClick }) {
   ...
   {!showCart? (
        <div className="product-grid"> {/* Outer container */}
            {plantsArray.map((category, index) => ( // Loop through each category
                <div key={index}> {/* Unique key for each category's content block */}
                    <h1> {/* Display the category name */}
                        <div>{category.category}</div>
                    </h1>
                    <div className="product-list"> {/* Container for the list of plant cards */}
                        {category.plants.map((plant) => ( // Loop through each plant in the category
                            <div className="product-card" key={plant.name}> {/* Use plant name as unique key */}
                                <img
                                    className="product-image"
                                    src={plant.image} // Display the plant image
                                    alt={plant.name} // Alt text
                                />
                                ...
                                >
                                    Add to Cart {/* Static button text */}
                                </button>
                            </div>
                        ))}
                    </div>
